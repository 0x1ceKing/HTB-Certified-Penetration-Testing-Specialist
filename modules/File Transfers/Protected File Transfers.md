...
- [Protected File Transfers](#protected-file-transfers)
  - [**File Encryption on Windows**](#file-encryption-on-windows)
    - [**Invoke-AESEncryption.ps1**](#invoke-aesencryptionps1)
  ...
  - [**File Encryption on Linux**](#file-encryption-on-linux)
    - [**Encrypting /etc/passwd with openssl**](#encrypting-etcpasswd-with-openssl)
    - [**Decrypt passwd.enc with openssl**](#decrypt-passwdenc-with-openssl)
...
```powershell
th1nyunb0y@htb[/htb]$ openssl enc -d -aes256 -iter 100000 -pbkdf2 -in passwd.enc -out passwd  
